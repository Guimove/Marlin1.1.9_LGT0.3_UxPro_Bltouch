...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 349.94
  #define DEFAULT_bedKi 62.82
  #define DEFAULT_bedKd 487.34
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 421.48 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -25 //-23  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -30 //0 // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.7 //0  // Z offset: -below +above  [the nozzle]
